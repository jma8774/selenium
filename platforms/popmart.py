      ...
      with SB(test=True, uc=True, headless=False) as sb:
        ...
        while True:
          try:
            ...
            if not sb.assert_text("THE MONSTERS - Have a Seat Vinyl Plush Blind Box", timeout=60):
            ...
            if "NOTIFY ME WHEN AVAILABLE" not in source:
              ...
              if current_time - last_notification_time > notification_interval:
                sendBotChannel("✅ Item is in stock: https://www.popmart.com/us/pop-now/set/50", user="jeemong")
